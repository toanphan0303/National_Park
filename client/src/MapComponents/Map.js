...
const MyMapComponent = compose(
  ...
  lifecycle({
    componentDidMount(){
      ...
      if(origin&& destination && !_.isEmpty(titles)){
  ...
  >
    {(props.locationList.startRoute===true && props.locationList.initial===false) ?
      props.directions &&  <DirectionsRenderer options={{suppressMarkers: false, markerOptions:{ animation:google.maps.Animation.DROP} }} directions={props.directions} /> : (props.locationList.startRoute ===false && props.locationList.initial ===false) ?
        (props.directions &&  <DirectionsRenderer options={{suppressMarkers: false, markerOptions:{ animation:google.maps.Animation.DROP} }}  directions={props.directions} />) :
        (props.directions &&
          <DirectionsRenderer options={{suppressMarkers: true, markerOptions:{ animation:google.maps.Animation.DROP} }} directions={props.directions}/>)
    }
